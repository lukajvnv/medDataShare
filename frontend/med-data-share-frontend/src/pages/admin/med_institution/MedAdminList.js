...
import {deleteUser, restoreUser, getMedInstitutionsAdmins} from "../../../services/SuperAdminService";
...
import {ListItemIcon, ListItemText, Menu, MenuItem, TableCell, IconButton} from "@material-ui/core";

import MoreVert from '@material-ui/icons/MoreVert';
import UndoIcon from '@material-ui/icons/Undo';
import DeleteIcon from '@material-ui/icons/Delete';

import AddMedAdmin from "./AddMedAdmin";

class MedAdminList extends TablePage {
    ...
    fetchData() {
        ...
        getMedInstitutionsAdmins({
            ...
            const medInstitutionsAdmins = response.data;

            this.setState({
                tableData: medInstitutionsAdmins,
                total: medInstitutionsAdmins.length,
                lockTable: false
            });
        });
    }
    ...
    getPageHeader() {
        return <h1>{ strings.medAdminList.pageTitle }</h1>;
    }

    renderAddContent() {
        return <AddMedAdmin onCancel={ this.onCancel } onFinish={ this.onFinish }/>
    }
...
export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(MedAdminList)));